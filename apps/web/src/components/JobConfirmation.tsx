  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col p-8 bg-white shadow-lg rounded-xl max-w-xl mx-auto mt-12">
        <h1 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Job Posting Updated Successfully!</h1>
        <p className="text-lg text-gray-600 mb-6 text-center">Your job posting has been updated. You can view your postings in the dashboard.</p>
        <button
          onClick={() => router.push('/dashboard/job-postings')}
